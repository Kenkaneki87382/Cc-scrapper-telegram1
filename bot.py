...
'''
This bot is developed by @KaNeKi354_bot, it is the first version deployed for public scraping,
...
@run_async
def start(update):
	update.message.reply_text("This CC Scraper has been started successfully | Developed by [@KaNeKi354_bot] kaneki")
